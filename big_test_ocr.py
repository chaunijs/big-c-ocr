...
async def test_single_url_ocr(url):
    print(f"🚀 Starting test for URL: {url}")
    badge_url = None

    # 1. Scrape the page for the badge
    ...
    # 2. Process the badge with OCR if found
...
if __name__ == "__main__":
    test_url = "https://www.bigc.co.th/en/product/fineline-fabric-softener-sunshine-gold-1-300-ml.11818189"
    asyncio.run(test_single_url_ocr(test_url))